...
class UserProfile {
     ...
     */
    setProfileImage() {
        if (this.profileImage && this.profileImage.tagName.toLowerCase() === "img") {
        ...
        `;
            this.profileImage.replaceWith(svgElement.firstElementChild);
        }
         else this.profileImage.src = getUserProfileImage();
    }
