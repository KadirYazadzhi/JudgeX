document.addEventListener('DOMContentLoaded', function () {
    class Validator {
        ...
        static validateMessage(message) {
            return typeof message === "string" && message.trim().length > 10 && message.value !== "" ;
        }
    ...
    class ContactForm {
        constructor() {
            ...
            emailjs.init('VT_BpXFAeAX8JEnDx'); // Replace 'your_user_id' with your actual user ID from EmailJS
