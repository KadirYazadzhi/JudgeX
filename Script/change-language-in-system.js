...
if (selectedCardIndex !== null) {
    switch (selectedCardIndex) {
        ...
        case "3":
            ...
            languageIcon.outerHTML = `
                <svg class="java" xmlns="http://www.w3.org/2000/svg" width="25%" height="25%" viewBox="0 0 24 24" >
        ...
        case "4":
            ...
            languageIcon.outerHTML = `
                <svg class="javascript" xmlns="http://www.w3.org/2000/svg" width="25%" height="25%" viewBox="0 0 24 24">
        ...
        case "5":
            ...
            languageIcon.outerHTML = `
                <svg class="typescript" xmlns="http://www.w3.org/2000/svg" width="25%" height="25%" viewBox="0 0 24 24" >
        ...
        case "6":
            ...
            languageIcon.outerHTML = `
                <svg class="php" xmlns="http://www.w3.org/2000/svg" width="25%" height="25%" viewBox="0 0 24 24">
        ...
        case "7":
            ...
            languageIcon.outerHTML = `
                <svg class="postgres" xmlns="http://www.w3.org/2000/svg" width="25%" height="25%" viewBox="0 0 24 24">
        ...
        case "8":
            ...
            languageIcon.outerHTML = `
                <svg class="go" xmlns="http://www.w3.org/2000/svg" width="25%" height="25%" viewBox="0 0 24 24">
